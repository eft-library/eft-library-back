...
from api.user.user_function import UserFunction, UserFunctionV3
        ...
        try:
            ...
            with DataBaseConnector.SessionLocal() as s:
                ...
                if user:
                    ...
                    UserFunction.delete_all_user_data(s, user_email)
                    s.commit()
                    return True
                else:
                    return False
...
class UserServiceV3:
    ...
    def get_my_page_default_v3(user_email: str):
        return UserServiceV3._get_my_page_simple_v3(
            user_email, UserFunctionV3.get_my_page_default_v3, "default"
        )
    ...
    @staticmethod
    def _get_my_page_simple_v3(user_email: str, fn, label: str):
        try:
            with V3Database.SessionLocal() as s:
                return fn(s, user_email)
        except Exception as e:
    ...
    def get_my_page_notification_v3(user_email: str, page_num: int):
        return UserServiceV3._get_my_page_paged_v3(
            user_email,
            page_num,
            UserFunctionV3.get_my_page_notification_v3,
            "notification",
        )
