...
@router.get("/v3/btr-routes/{normalized_name}")
def get_live_map_btr_routes_v3(normalized_name: str):
    routes = LiveMapServiceV3.get_btr_routes_v3(normalized_name)
    if routes is None:
        return CustomResponse.response(None, HTTPCode.OK, Message.FAIL)
    return CustomResponse.response(routes, HTTPCode.OK, Message.SUCCESS)
