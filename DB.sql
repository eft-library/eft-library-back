...
COMMENT ON COLUMN TKL_NOTICE.ID IS 'Notice ID';
COMMENT ON COLUMN TKL_NOTICE.NAME_EN IS 'Notice 이름 영문';
COMMENT ON COLUMN TKL_NOTICE.NAME_KR IS 'Notice 이름 한글';
COMMENT ON COLUMN TKL_NOTICE.NOTICE_TEXT_EN IS 'Notice 설명 영문';
COMMENT ON COLUMN TKL_NOTICE.NOTICE_TEXT_KR IS 'Notice 설명 한글';
COMMENT ON COLUMN TKL_NOTICE.UPDATE_TIME IS 'Notice 업데이트 시간';