...
COMMENT ON COLUMN TKL_BOSS_LOOT.ITEM_NAME_EN IS '보스 전리품 아이템 이름';
COMMENT ON COLUMN TKL_BOSS_LOOT.ITEM_NAME_KR IS '보스 전리품 아이템 이름';
COMMENT ON COLUMN TKL_BOSS_LOOT.BOSS_NAME_EN IS '보스 전리품 보스 이름';
COMMENT ON COLUMN TKL_BOSS_LOOT.BOSS_NAME_KR IS '보스 전리품 보스 이름';
COMMENT ON COLUMN TKL_BOSS_LOOT.ITEM_TYPE IS '보스 전리품 아이템 타입 값';
COMMENT ON COLUMN TKL_BOSS_LOOT.ITEM_TYPE_EN IS '보스 전리품 아이템 타입 영문';
COMMENT ON COLUMN TKL_BOSS_LOOT.ITEM_TYPE_KR IS '보스 전리품 아이템 타입 한글';
COMMENT ON COLUMN TKL_BOSS_LOOT.ITEM_IMAGE IS '보스 전리품 아이템 이미지';
COMMENT ON COLUMN TKL_BOSS_LOOT.LINK IS '보스 전리품 아이템 링크';
...
COMMENT ON COLUMN TKL_FORUM.ID IS '게시글 자동 생성 ID';
COMMENT ON COLUMN TKL_FORUM.TITLE IS '게시글 제목';
COMMENT ON COLUMN TKL_FORUM.CONTENTS IS '게시글 내용';
COMMENT ON COLUMN TKL_FORUM.THUMBNAIL IS '게시글 썸네일';
COMMENT ON COLUMN TKL_FORUM.WRITER IS '게시글 작성자';
COMMENT ON COLUMN TKL_FORUM.LIKE_COUNT IS '게시글 좋아요 수';
COMMENT ON COLUMN TKL_FORUM.DISLIKE_COUNT IS '게시글 싫어요 수';
COMMENT ON COLUMN TKL_FORUM.VIEW_COUNT IS '게시글 조회수';
COMMENT ON COLUMN TKL_FORUM.TYPE IS '게시글 타입';
COMMENT ON COLUMN TKL_FORUM.CREATE_TIME IS '게시글 생성 시간';
COMMENT ON COLUMN TKL_FORUM.UPDATE_TIME IS '게시글 수정 시간';
...
COMMENT ON COLUMN TKL_ISSUE.BOARD_ID IS '게시글 ID';
COMMENT ON COLUMN TKL_ISSUE.LIKE_COUNT IS '게시글 ID';
COMMENT ON COLUMN TKL_ISSUE.WRITER IS '게시글 ID';
COMMENT ON COLUMN TKL_ISSUE.UPDATE_TIME IS '게시글 ID';
...
COMMENT ON COLUMN TKL_TIP.ID IS '팁 게시글 자동 생성 ID';
COMMENT ON COLUMN TKL_TIP.TITLE IS '팁 게시글 제목';
COMMENT ON COLUMN TKL_TIP.CONTENTS IS '팁 게시글 내용';
COMMENT ON COLUMN TKL_TIP.THUMBNAIL IS '팁 게시글 썸네일';
COMMENT ON COLUMN TKL_TIP.WRITER IS '팁 게시글 작성자';
COMMENT ON COLUMN TKL_TIP.LIKE_COUNT IS '팁 게시글 좋아요 수';
COMMENT ON COLUMN TKL_TIP.DISLIKE_COUNT IS '팁 게시글 싫어요 수';
COMMENT ON COLUMN TKL_TIP.VIEW_COUNT IS '팁 게시글 조회수';
COMMENT ON COLUMN TKL_TIP.TYPE IS '팁 게시글 타입';
COMMENT ON COLUMN TKL_TIP.CREATE_TIME IS '팁 게시글 생성 시간';
COMMENT ON COLUMN TKL_TIP.UPDATE_TIME IS '팁 게시글 수정 시간';

-- incident
CREATE TABLE TKL_INCIDENT
(
    ID BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    TITLE TEXT,
    CONTENTS TEXT,
...
COMMENT ON COLUMN TKL_INCIDENT.ID IS '사건 사고 게시글 자동 생성 ID';
COMMENT ON COLUMN TKL_INCIDENT.TITLE IS '사건 사고 게시글 제목';
COMMENT ON COLUMN TKL_INCIDENT.CONTENTS IS '사건 사고 게시글 내용';
COMMENT ON COLUMN TKL_INCIDENT.THUMBNAIL IS '사건 사고 게시글 썸네일';
COMMENT ON COLUMN TKL_INCIDENT.WRITER IS '사건 사고 게시글 작성자';
COMMENT ON COLUMN TKL_INCIDENT.LIKE_COUNT IS '사건 사고 게시글 좋아요 수';
COMMENT ON COLUMN TKL_INCIDENT.DISLIKE_COUNT IS '사건 사고 게시글 싫어요 수';
COMMENT ON COLUMN TKL_INCIDENT.VIEW_COUNT IS '사건 사고 게시글 조회수';
COMMENT ON COLUMN TKL_INCIDENT.TYPE IS '사건 사고 게시글 타입';
COMMENT ON COLUMN TKL_INCIDENT.CREATE_TIME IS '사건 사고 게시글 생성 시간';
COMMENT ON COLUMN TKL_INCIDENT.UPDATE_TIME IS '사건 사고 게시글 수정 시간';

-- humor
CREATE TABLE TKL_HUMOR
(
    ID BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    TITLE TEXT,
    CONTENTS TEXT,
...
COMMENT ON COLUMN TKL_HUMOR.ID IS '유머 게시글 자동 생성 ID';
COMMENT ON COLUMN TKL_HUMOR.TITLE IS '유머 게시글 제목';
COMMENT ON COLUMN TKL_HUMOR.CONTENTS IS '유머 게시글 내용';
COMMENT ON COLUMN TKL_HUMOR.THUMBNAIL IS '유머 게시글 썸네일';
COMMENT ON COLUMN TKL_HUMOR.WRITER IS '유머 게시글 작성자';
COMMENT ON COLUMN TKL_HUMOR.LIKE_COUNT IS '유머 게시글 좋아요 수';
COMMENT ON COLUMN TKL_HUMOR.DISLIKE_COUNT IS '유머 게시글 싫어요 수';
COMMENT ON COLUMN TKL_HUMOR.VIEW_COUNT IS '유머 게시글 조회수';
COMMENT ON COLUMN TKL_HUMOR.TYPE IS '유머 게시글 타입';
COMMENT ON COLUMN TKL_HUMOR.CREATE_TIME IS '유머 게시글 생성 시간';
COMMENT ON COLUMN TKL_HUMOR.UPDATE_TIME IS '유머 게시글 수정 시간';
