...
COMMENT ON COLUMN TKL_USER.IMAGE IS '사용자 아이콘';
COMMENT ON COLUMN TKL_USER.IMAGE_LIST IS '사용자 아이콘 리스트';
COMMENT ON COLUMN TKL_USER.NICK_NAME IS '사용자 닉네임';
COMMENT ON COLUMN TKL_USER.POINT IS '사용자 포인트';
COMMENT ON COLUMN TKL_USER.IS_BAN IS '사용자 블랙 여부';
COMMENT ON COLUMN TKL_USER.IS_DELETE IS '사용자 삭제 여부';
...
COMMENT ON COLUMN TKL_USER.UPDATE_TIME IS '사용자 밴 끝나는 날짜';
COMMENT ON COLUMN TKL_USER.DELETE_TIME IS '사용자 삭제 요청일';
