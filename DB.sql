...
COMMENT ON COLUMN TKL_WHERE_AM_I.ID IS 'where am i 아이디';
COMMENT ON COLUMN TKL_WHERE_AM_I.NAME IS 'where am i 맵 이름';
COMMENT ON COLUMN TKL_WHERE_AM_I.IMAGE IS 'where am i 이미지';
COMMENT ON COLUMN TKL_WHERE_AM_I.MAP_BOUNDS IS 'where am i Map bounds';
COMMENT ON COLUMN TKL_WHERE_AM_I.IMAGE_BOUNDS IS 'where am i image bounds';
COMMENT ON COLUMN TKL_WHERE_AM_I.UPDATE_TIME IS 'where am i 업데이트 날짜';