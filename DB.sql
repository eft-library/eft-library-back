...
COMMENT ON COLUMN TKL_NEWS.USER_FUNCTION IS '뉴스 사용자 기능';
...
COMMENT ON COLUMN TKL_BOARD_TRASH.ID IS '게시글 자동 생성 ID';
COMMENT ON COLUMN TKL_BOARD_TRASH.TITLE IS '게시글 제목';
COMMENT ON COLUMN TKL_BOARD_TRASH.CONTENTS IS '게시글 내용';
COMMENT ON COLUMN TKL_BOARD_TRASH.THUMBNAIL IS '게시글 썸네일';
COMMENT ON COLUMN TKL_BOARD_TRASH.WRITER IS '게시글 작성자';
COMMENT ON COLUMN TKL_BOARD_TRASH.LIKE_COUNT IS '게시글 좋아요 수';
COMMENT ON COLUMN TKL_BOARD_TRASH.VIEW_COUNT IS '게시글 조회수';
COMMENT ON COLUMN TKL_BOARD_TRASH.TYPE IS '게시글 타입';
COMMENT ON COLUMN TKL_BOARD_TRASH.CREATE_TIME IS '게시글 생성 시간';
COMMENT ON COLUMN TKL_BOARD_TRASH.UPDATE_TIME IS '게시글 수정 시간';
