...
COMMENT ON COLUMN TKL_EVENT.NPC_VALUE IS 'Event NPC 값';
COMMENT ON COLUMN TKL_EVENT.NAME_EN IS 'Event 이름 영문';
COMMENT ON COLUMN TKL_EVENT.NAME_KR IS 'Event 이름 한글';
COMMENT ON COLUMN TKL_EVENT.OBJECTIVES_EN IS 'Event 목표 영문';
COMMENT ON COLUMN TKL_EVENT.OBJECTIVES_KR IS 'Event 목표 한글';
COMMENT ON COLUMN TKL_EVENT.REWARDS_EN IS 'Event 보상 영문';
COMMENT ON COLUMN TKL_EVENT.REWARDS_KR IS 'Event 보상 한글';
COMMENT ON COLUMN TKL_EVENT.REQUIRED_KAPPA IS '카파 컨테이너에 필요한지 여부';
COMMENT ON COLUMN TKL_EVENT."order" IS 'Event 순서';
COMMENT ON COLUMN TKL_EVENT.GUIDE IS 'Event 가이드';
COMMENT ON COLUMN TKL_EVENT.REQUIRES IS 'Event 이전 단계';
COMMENT ON COLUMN TKL_EVENT.NEXT IS 'Event 다음 단계';
