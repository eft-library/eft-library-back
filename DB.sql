...
COMMENT ON COLUMN TKL_EVENT.EVENT_TEXT_EN IS 'Event 설명 영문';
COMMENT ON COLUMN TKL_EVENT.EVENT_TEXT_KR IS 'Event 설명 한글';
...
COMMENT ON COLUMN TKL_PATCH_NOTES.PATCH_NOTES_EN IS '패치 노트 설명 영문';
COMMENT ON COLUMN TKL_PATCH_NOTES.PATCH_NOTES_KR IS '패치 노트 설명 한글';
...
COMMENT ON COLUMN TKL_NOTICE.NOTICE_EN IS '공지사항 설명 영문';
COMMENT ON COLUMN TKL_NOTICE.NOTICE_KR IS '공지사항설명 한글';
